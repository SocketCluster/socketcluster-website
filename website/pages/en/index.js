    ...
    return (
      <div>
        ...
        <div className="splashSubsection">
          <div className="splashSubsectionCaption">Sponsors</div>
          <div className="splashLogoContainer">
            ...
            <a className="splashSubsectionLink" href={`https://leasehold.io`} target="_blank">
              <div className="splashSubsectionItem">
                <img className="splashLogo" style={{height: '40px', paddingBottom: '10px'}} src={`${baseUrl}img/leasehold-logo-with-text-white.png`} />
              </div>
            </a>
          </div>
        </div>
